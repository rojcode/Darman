(function () {
  ...
  const structuredData = {
    ...
    description:
      "دارمان روانکار پارس یک شرکت ایرانی پیشرو در تولید روانکارهای صنعتی و خودرویی است. محصولات شامل روغن موتور، روغن گیربکس، روغن هیدرولیک، روغن ترمز، روغن توربین، روغن ترانس، گریس صنعتی و محصولات پایه آب است. هدف ما ارائه محصولاتی با کیفیت پایدار و اعتماد مشتریان است.",
      ...
      itemListElement: [
        // مثال برای همه محصولات با offers
        {
          ...
          itemOffered: {
            ...
            name: "روغن هیدرولیک",
            description:
              "روغن مخصوص سیستم‌های هیدرولیک صنعتی با مقاومت بالا در برابر فشار و دما.",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description:
              "روغن تخصصی برای سیستم‌های خنک‌کننده و انتقال حرارت در صنایع سنگین.",
            category: "روغن‌های صنعتی",
            application:
              "مورد استفاده در بویلرها، مبدل‌های حرارتی و سیستم‌های صنعتی",
            offers: {
              "@type": "Offer",
              priceCurrency: "IRR",
              price: "1800000",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            name: "روغن ترانس",
            description:
              "روغن برای گیربکس‌ها و سیستم‌های انتقال قدرت صنعتی و کشاورزی.",
            category: "روغن‌های صنعتی",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            name: "روغن توربین",
            description:
              "روغن مخصوص توربین‌های گازی و بخار با خواص پایدار در دماهای بالا.",
            category: "روغن‌های صنعتی",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            name: "روغن موتور",
            description:
              "روغن موتور با فرمولاسیون پیشرفته برای کاهش مصرف سوخت و افزایش عمر موتور.",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            name: "روغن گیربکس",
            description:
              "روغن مخصوص گیربکس دستی و اتوماتیک با مقاومت بالا در دما و فشار.",
            category: "روغن‌های خودرویی",
            application:
              "مورد استفاده در تمامی خودروها و ماشین‌آلات سبک و سنگین",
            offers: {
              "@type": "Offer",
              priceCurrency: "IRR",
              price: "1400000",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            name: "روغن ترمز",
            description:
              "روغن ترمز با نقطه جوش بالا برای ایمنی سیستم ترمز در شرایط سخت.",
            category: "روغن‌های خودرویی",
            application: "مناسب برای خودروهای سبک و سنگین",
            offers: {
              "@type": "Offer",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            name: "گریس صنعتی",
            description:
              "گریس مخصوص روانکاری یاتاقان‌ها و قطعات متحرک با تحمل فشار و دمای بالا.",
            category: "گریس",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            name: "ضد یخ",
            description:
              "محصول پایه آب برای جلوگیری از یخ‌زدگی سیستم خنک‌کننده خودروها.",
    ...
    additionalProperty: [
      {
        ...
        name: "ماموریت",
        value:
          "ارائه روانکارهای باکیفیت، قابل اعتماد و مطابق با نیازهای صنایع و خودروهای ایرانی",
      },
      {
        "@type": "PropertyValue",
        name: "چشم‌انداز",
        value:
          "تبدیل شدن به مرجع اصلی تولید روانکارهای صنعتی و خودرویی در ایران و ارتقای استانداردهای کیفی این صنعت",
      },
      {
        "@type": "PropertyValue",
        name: "هویت برند",
        value:
          "دارمان روانکار پارس با ترکیب دانش فنی پیشرفته، مواد اولیه باکیفیت و تیم متخصص، محصولاتی با عملکرد بالا، دوام طولانی و اعتماد مشتریان تولید می‌کند.",
      },
    ],
  };
